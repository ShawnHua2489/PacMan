...
class InferenceModule:
    ...
    def getObservationProb(self, noisyDistance, pacmanPosition, ghostPosition, jailPosition):
        ...
        isNoisyDisNone = noisyDistance is None

        if isGhostInJail or isNoisyDisNone:
            return 1 if isGhostInJail and isNoisyDisNone else 0
...
class ParticleFilter(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for pos in self.particles:
            newbeliefs[pos] += self.getObservationProb(observation, gameState.getPacmanPosition(), pos, self.getJailPosition())
        ...
        if newbeliefs.total() == 0:
            ...
            self.beliefs = newbeliefs
            self.particles = [self.beliefs.sample() for __ in range(self.numParticles)]
